...
export default function AddRestaurantForm({ toastRef, setLoading, navigation }) {
    ...
    const validForm = () => {
        ...
        if (!validateEmail(formData.email)) {
            setErrorEmail("debes ingresar un mail del restaurante valido")
            isValid = false
        }
        ...
        if (isEmpty(formData.description)) {
            setErrorDescription("debes ingresar la descripcion del restaurante")
            isValid = false
        }
        ...
        if (!locationRestaurant) {
            ...
            toastRef.current.show("debes agregar al menos una imagen del restaurante", 3000)
            isValid = false
        }
        return isValid
    }
...
function MapRestaurant({ isVisibleMap, setIsVisibleMap, setLocationRestaurant, toastRef }) {
    ...
    const confirmLocation = () => {
        ...
        toastRef.current.show("Localizacion guardada correctamente", 300)
